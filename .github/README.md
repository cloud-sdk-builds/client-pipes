...
[`@aws-sdk/client-pipes`](https://www.npmjs.com/package/@aws-sdk/client-pipes/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pipes@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vKDUtFqDEio2jSqSlzkfmZs0woFmlrHQCP/iffow+LucxQfVSs9B6IVB1VVWfLho
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pipes": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pipes@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pipes@3.476.0/index.min.mjs": "sha384-vKDUtFqDEio2jSqSlzkfmZs0woFmlrHQCP/iffow+LucxQfVSs9B6IVB1VVWfLho"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pipes/blob/refs/tags/3.476.0/LICENSE
```
